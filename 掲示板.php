...
<body>
    ...
    <?php
        ...
        if (!empty($_POST["editNum"]) && !empty($_POST["password"])) {
            $dbh = dbConnect();
            $id = htmlspecialchars($_POST['editNum'], ENT_QUOTES, "UTF-8");
    ...
    <?php
        ...
        if(!empty($_POST["editPostNum"]) && !empty($_POST["name"]) && !empty($_POST["comment"])) {
            $dbh = dbConnect();
            $id = htmlspecialchars($_POST['editPostNum'], ENT_QUOTES, "UTF-8");
            $name = htmlspecialchars($_POST['name'], ENT_QUOTES, "UTF-8");
            $comment = htmlspecialchars($_POST['comment'], ENT_QUOTES, "UTF-8");
        ...
        if (!empty($_POST["deleteNum"]) && !empty($_POST["password"])) {
            $dbh = dbConnect();
            $id = htmlspecialchars($_POST['deleteNum'], ENT_QUOTES, "UTF-8");
            $password = htmlspecialchars($_POST['password'], ENT_QUOTES, "UTF-8");
